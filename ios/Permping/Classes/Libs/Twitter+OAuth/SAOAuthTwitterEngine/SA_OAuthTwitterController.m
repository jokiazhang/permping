...
- (void) loadView {
    ...
    _backgroundView.backgroundColor = [UIColor colorWithRed:108.0f/255.0f green:217.0f/255.0f blue:249.0f/255.0f alpha:255.0f/255.0f];
...
- (NSString *) getAuthVerifierInWebView: (UIWebView *)webView {
    [webView stringByEvaluatingJavaScriptFromString:@"var script = document.createElement('script');"
     ...
     "var href = as[i].href;"
     "if (href.indexOf('auth_verifier') > 0) {" 
     " var mySplitResult = href.split('auth_verifier=');"
     " return mySplitResult[1];"
     " } "
     "else if (href.indexOf('oauth_verifier') > 0) {"
